...
<div class="container" style = "padding-top: 68px;">
    ...
    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
        ...
        <div class="form-group">
            ...
            <label for="sel1">Veuillez sélectionner un de vos bénéficiaires:</label>

            <select name='my_benef' class="form-control">
            <?php require_once '../controllers/pdo_u_ope_2.php'; ?>
            </select>

            <small class="form-text text-muted"><?php echo $my_benef_err;?></small>
